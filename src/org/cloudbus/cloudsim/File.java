...
public class File {
	 ...
	 * @throws org.cloudbus.cloudsim.ParameterException This happens when one of the following scenarios occur:
	 *             <ul>
	 ...
	 * @throws org.cloudbus.cloudsim.ParameterException This happens when the source file is <tt>null</tt>
	 */
	 ...
	 * @return <tt>true</tt> if successful, <tt>false</tt> otherwise
	 * @see gridsim.datagrid.storage.Storage#addFile(org.cloudbus.cloudsim.File)
	 * @see gridsim.datagrid.storage.Storage#addFile(List)
	 * @see gridsim.datagrid.storage.Storage#addReservedFile(org.cloudbus.cloudsim.File)
	 * @see gridsim.datagrid.storage.Storage#deleteFile(org.cloudbus.cloudsim.File)
	 * @see gridsim.datagrid.storage.Storage#deleteFile(String)
	 * @see gridsim.datagrid.storage.Storage#deleteFile(String, org.cloudbus.cloudsim.File)
	 * @see gridsim.datagrid.storage.Storage#getFile(String)
	 * @see gridsim.datagrid.storage.Storage#renameFile(org.cloudbus.cloudsim.File, String)
	 */
