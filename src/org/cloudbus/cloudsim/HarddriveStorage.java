...
public class HarddriveStorage implements Storage {
	 ...
	 * @throws org.cloudbus.cloudsim.ParameterException when the name and the capacity are not valid
	 */
	 ...
	 * 
	 * @param capacity the capacity in MByte
	 * @throws org.cloudbus.cloudsim.ParameterException when the capacity is not valid
	 */
