...
public class CloudSimTags {
	 ...
	 * {@link org.cloudbus.cloudsim.core.CloudSimShutdown} to trigger the end of the simulation
	 */
    ...
    //VM_LOCAL_TUNING
    //VM_GLOBAL_TUNONG
    public static final int VM_LOCAL_TUNING = BASE + 49;

    public static final int VM_GLOBAL_TUNING = BASE + 50;

    public static final int CLOUDLET_CREATE = BASE + 51;
