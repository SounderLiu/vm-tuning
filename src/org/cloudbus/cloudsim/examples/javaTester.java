...
/**
 * Created by Sounder Liu on 14-1-21.
 */
...
public class javaTester{
    ...
    public double getUtilization(double time) {
        ...
        double utilization = (double)getRandomGenerator().nextInt(100)/10000;
    ...
    public static void main(String[] args){
        ...
        for(int i = 0; i<100; i++){
            System.out.println(jt.getUtilization(i));
