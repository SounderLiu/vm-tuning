...
//    public final static int CLOUDLET_LENGTH	= 2500 * (int) SIMULATION_LIMIT;
    public final static int CLOUDLET_LENGTH	= 60;
	 ...
	 */
    public final static int HOST_TUNING_TYPE = 0;
	public final static int HOST_TYPES	 = 2;
	public final static int[] HOST_MIPS	 = { 2660, 2660 };
	public final static int[] HOST_PES	 = { 24, 2 };
	public final static int[] HOST_RAM	 = { 32768, 4096 };
	public final static int HOST_BW		 = 10000000; // 1 Gbit/s
	public final static int HOST_STORAGE = 1000000000; // 1 TB


    public final static int CLOUDLET_CREATE_INTERVAL = 40; //Cloudlet 鍒涘缓鏃堕棿闂撮殧
    public final static int CLOUDLET_NUM = 1000; //姣忔鍒涘缓Cloudlet涓暟
    public final static int VM_NUM = 400;
    public final static double GLOBAL_INTERVIAL = 100.0;//GlobalTuning 鎵ц闂撮殧锛堟湭閲囩敤锛屽悗鏀逛负鐢⊿CHEDULING_INTERVAL璋冩暣锛�
    public final static double LOCAL_INTERVIAL = 20.0;//LocalTuning闂撮殧
    public final static double MIGRATION_THR = 2.0;//杩佺Щ闃堝�

    public final static int WORKLOAD_DOWN = 0;//涓暟涓嬮檺

    public final static int WORKLOAD_UP = 50;//workload涓暟涓婇檺
    public final static double SCALING_PARAMETER = 1;//s(1)
