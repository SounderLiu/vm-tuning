/**
 * Created by Sounder Liu on 14-1-25.
 */
 ...
 * @since Jan 5, 2012
 */
public class TuningRunner extends RunnerAbstract {
    ...
    protected void init(String inputFolder) {
        try {
            ...
            cloudletList = TuningHelper.createCloudletListPlanetLab(brokerId, Constants.CLOUDLET_NUM);
            vmList = Helper.createVmList(brokerId, Constants.VM_NUM);
